...
$statementt = $db_con->prepare("select * from student WHERE first_name like '%$query%' and student_id > :student_id");
...
$statement = $db_con->prepare("select * from student WHERE first_name or last_name or user_name or email like '%$query%' ORDER BY student_id ASC LIMIT $start_from, $limit");
$statement->execute();
